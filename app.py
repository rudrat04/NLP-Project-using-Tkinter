...
class NLPApp:
    ...
    def home_gui(self):
        ...
        emotion_btn = Button(self.root, text='Emotion Prediction', width=30, height=4,command=self.emotion_pred_gui)
    ...
    def ner_gui(self):
        ...
        goback_btn = Button(self.root, text='Go Back', command=self.home_gui)
        goback_btn.pack(pady=(10, 10), padx=(10,10))
    ...
    def emotion_pred_gui(self):
        ...
        emotion_btn = Button(self.root, text='Analyze Emotion', command=self.do_emotion_prediction)
        emotion_btn.pack(pady=(10, 10))
